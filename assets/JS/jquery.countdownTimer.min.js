...
!(function (n) {
  function t(t, c) {
    ...
    if (
      ...
      (h = S.fontColor),
      (v = S.backgroundColor),
      void 0 != c.regexpMatchFormat &&
        void 0 != c.regexpReplaceWith &&
        void 0 == c.timeSeparator &&
        ((window["regexpMatchFormat_" + t.attr("id")] = c.regexpMatchFormat),
        (window["regexpReplaceWith_" + t.attr("id")] = c.regexpReplaceWith)),
      void 0 != c.borderColor ||
        void 0 != c.fontColor ||
        void 0 != c.backgroundColor)
    ) {
      var g = { background: v, color: h, "border-color": M };
      t.css(g);
    ...
    if (
      ...
      (void 0 == c.hours && void 0 == c.minutes && void 0 == c.seconds)
    )
      if (
        void 0 != c.startDate &&
        void 0 != c.dateAndTime &&
        ...
        var I =
            S.startDate.getHours() < 10
              ? "0" + S.startDate.getHours()
              : S.startDate.getHours(),
          f =
            S.startDate.getMinutes() < 10
              ? "0" + S.startDate.getMinutes()
              : S.startDate.getMinutes(),
          k =
            S.startDate.getSeconds() < 10
              ? "0" + S.startDate.getSeconds()
              : S.startDate.getSeconds(),
          D =
            S.startDate.getMonth() + 1 < 10
              ? "0" + (S.startDate.getMonth() + 1)
              : S.startDate.getMonth() + 1,
          T =
            S.startDate.getDate() < 10
              ? "0" + S.startDate.getDate()
              : S.startDate.getDate(),
          x = S.startDate.getFullYear();
        (window["startTime" + t.attr("id")] = new Date(
          x + "/" + D + "/" + T + " " + I + ":" + f + ":" + k
        )),
        ...
        void 0 != c.currentTime
          ? ((currentTime = ""),
            ...
            _(t, S),
            (window["timer_currentDate" + t.attr("id")] = setInterval(
              function () {
                _(t, S);
              },
              1e3 * S.tickInterval
          ...
          : ((countSeconds = ""),
            ...
            (window["timer_secondsTimer" + t.attr("id")] = setInterval(
              function () {
                u(t);
              },
              1e3
      ...
      void 0 != c.hours && void 0 == c.minutes && void 0 == c.seconds
        ? ((hours_H = ""),
          ...
          void 0 != c.pauseButton && l(t, "H", S, e),
          void 0 != c.stopButton && H(t, "H", S, e),
          e(t, S),
        ...
        ? ((hours_M = ""),
          ...
          void 0 != c.pauseButton && l(t, "M", S, o),
          void 0 != c.stopButton && H(t, "M", S, o),
          o(t, S),
        ...
        ? ((hours_S = ""),
          ...
          void 0 != c.pauseButton && l(t, "S", S, i),
          void 0 != c.stopButton && H(t, "S", S, i),
          i(t, S),
        ...
        ? ((hours_HM = ""),
          ...
          void 0 != c.pauseButton && l(t, "HM", S, w),
          void 0 != c.stopButton && H(t, "HM", S, w),
          w(t, S),
        ...
        ? ((hours_MS = ""),
          ...
          void 0 != c.pauseButton && l(t, "MS", S, d),
          void 0 != c.stopButton && H(t, "MS", S, d),
          d(t, S),
        ...
        ? ((hours_HS = ""),
          ...
          void 0 != c.pauseButton && l(t, "HS", S, s),
          void 0 != c.stopButton && H(t, "HS", S, s),
          s(t, S),
        ...
        : void 0 != c.hours &&
          ...
          void 0 != c.pauseButton && l(t, "HMS", S, r),
          void 0 != c.stopButton && H(t, "HMS", S, r),
          r(t, S),
  ...
  function e(n, t) {
    var e = n.attr("id");
    window["minutes_H" + e] == t.minutes &&
    window["seconds_H" + e] == t.seconds &&
    window["hours_H" + e] == t.hours
      ? (window["hours_H" + e].toString().length < 2 &&
      ...
      : (window["hours_H" + e].toString().length < 2 &&
          (window["hours_H" + e] = "0" + window["hours_H" + e]),
        window["minutes_H" + e].toString().length < 2 &&
          (window["minutes_H" + e] = "0" + window["minutes_H" + e]),
        window["seconds_H" + e].toString().length < 2 &&
        ...
        0 != window["minutes_H" + e] &&
          window["seconds_H" + e] < 0 &&
          (window["minutes_H" + e]--,
          (window["seconds_H" + e] = 60 - t.tickInterval)),
        0 == window["minutes_H" + e] &&
          window["seconds_H" + e] < 0 &&
  ...
  function o(n, t) {
    ...
    window["minutes_M" + e] == t.minutes && window["seconds_M" + e] == t.seconds
      ...
      : (window["minutes_M" + e].toString().length < 2 &&
          (window["minutes_M" + e] = "0" + window["minutes_M" + e]),
        window["seconds_M" + e].toString().length < 2 &&
          (window["seconds_M" + e] = "0" + window["seconds_M" + e]),
        S(
          n,
          window["minutes_M" + e] + t.timeSeparator + window["seconds_M" + e]
        ),
        (window["seconds_M" + e] -= t.tickInterval),
        0 != window["minutes_M" + e] &&
          window["seconds_M" + e] < 0 &&
          (window["minutes_M" + e]--,
          (window["seconds_M" + e] = 60 - t.tickInterval)),
        0 == window["minutes_M" + e] &&
          window["seconds_M" + e] < 0 &&
  ...
  function w(n, t) {
    var e = n.attr("id");
    window["minutes_HM" + e] == t.minutes && window["hours_HM" + e] == t.hours
      ? (window["hours_HM" + e].toString().length < 2 &&
          (window["hours_HM" + e] = "0" + window["hours_HM" + e]),
        window["minutes_HM" + e].toString().length < 2 &&
        ...
        0 != window["hours_HM" + e] && 0 == window["minutes_HM" + e]
          ? (window["hours_HM" + e]--,
          ...
          : ((window["seconds_HM" + e] = 60 - t.tickInterval),
            window["minutes_HM" + e]--),
        0 == window["hours_HM" + e] &&
          0 == window["minutes_HM" + e] &&
          60 == window["seconds_HM" + e] &&
      ...
      : (window["hours_HM" + e].toString().length < 2 &&
        ...
        window["minutes_HM" + e].toString().length < 2 &&
          (window["minutes_HM" + e] = "0" + window["minutes_HM" + e]),
        window["seconds_HM" + e].toString().length < 2 &&
  ...
  function d(n, t) {
    var e = n.attr("id");
    window["minutes_MS" + e] == t.minutes &&
    window["seconds_MS" + e] == t.seconds
      ? (window["minutes_MS" + e].toString().length < 2 &&
          (window["minutes_MS" + e] = "0" + window["minutes_MS" + e]),
        window["seconds_MS" + e].toString().length < 2 &&
          (window["seconds_MS" + e] = "0" + window["seconds_MS" + e]),
        S(
          n,
          window["minutes_MS" + e] + t.timeSeparator + window["seconds_MS" + e]
        ),
        0 != window["minutes_MS" + e] && 0 == window["seconds_MS" + e]
          ? (window["minutes_MS" + e]--,
      ...
      : (window["minutes_MS" + e].toString().length < 2 &&
        ...
        (window["seconds_MS" + e] -= t.tickInterval),
        0 != window["minutes_MS" + e] &&
          window["seconds_MS" + e] < 0 &&
          (window["minutes_MS" + e]--,
          (window["seconds_MS" + e] = 60 - t.tickInterval)),
        0 == window["minutes_MS" + e] &&
          window["seconds_MS" + e] < 0 &&
  ...
  function s(n, t) {
    var e = n.attr("id");
    window["seconds_HS" + e] == t.seconds && window["hours_HS" + e] == t.hours
      ? (window["hours_HS" + e].toString().length < 2 &&
          (window["hours_HS" + e] = "0" + window["hours_HS" + e]),
        window["seconds_HS" + e].toString().length < 2 &&
        ...
        0 == window["hours_HS" + e] && 0 == window["seconds_HS" + e]
      ...
      : (window["hours_HS" + e].toString().length < 2 &&
          (window["hours_HS" + e] = "0" + window["hours_HS" + e]),
        window["minutes_HS" + e].toString().length < 2 &&
        ...
        (window["seconds_HS" + e] -= t.tickInterval),
        0 != window["minutes_HS" + e] &&
          window["seconds_HS" + e] < 0 &&
          (window["minutes_HS" + e]--,
          (window["seconds_HS" + e] = 60 - t.tickInterval)),
        0 == window["minutes_HS" + e] &&
          window["seconds_HS" + e] < 0 &&
  ...
  function r(n, t) {
    var e = n.attr("id");
    window["minutes_HMS" + e] == t.minutes &&
    window["seconds_HMS" + e] == t.seconds &&
    window["hours_HMS" + e] == t.hours
      ? (window["hours_HMS" + e].toString().length < 2 &&
          (window["hours_HMS" + e] = "0" + window["hours_HMS" + e]),
        window["minutes_HMS" + e].toString().length < 2 &&
          (window["minutes_HMS" + e] = "0" + window["minutes_HMS" + e]),
        window["seconds_HMS" + e].toString().length < 2 &&
        ...
        S(
          ...
          window["hours_HMS" + e] +
            ...
            t.timeSeparator +
            window["seconds_HMS" + e]
        ),
        0 == window["hours_HMS" + e] &&
        0 == window["minutes_HMS" + e] &&
        0 == window["seconds_HMS" + e]
  ...
  function a(n, t, e) {
    var o = n.attr("id"),
      ...
      w =
        "withnoStart" == e ? window["startTime" + o] : window["startDate" + o],
    ...
    i - w > 0
      ? (d.toString().length < 2 && (d = "0" + d),
        ...
        S(
          n,
          d + t.timeSeparator + s + t.timeSeparator + r + t.timeSeparator + a
        ),
        "withnoStart" == e
          ? window["startTime" + o].setSeconds(
              window["startTime" + o].getSeconds() + t.tickInterval
            )
          : window["startDate" + o].setSeconds(
              window["startDate" + o].getSeconds() + t.tickInterval
            ))
      : (S(
          n,
          "00" +
  ...
  function _(n, t) {
    if (1 == window["currentTime" + n.attr("id")]) {
      ...
      o.toString().length < 2 && (o = "0" + o),
        ...
        w.toString().length < 2 && (w = "0" + w),
        S(n, o + t.timeSeparator + i + t.timeSeparator + w);
    } else alert("Set Current Time option.");
  }
  function u(n) {
    var t = n.attr("id");
    window["countSeconds" + t].toString().length < 2 &&
      (window["countSeconds" + t] = "0" + window["countSeconds" + t]),
      S(n, window["countSeconds" + t] + " sec"),
      window["countSeconds" + t]--,
      -1 == window["countSeconds" + t] &&
        (delete window["countSeconds" + t],
        clearInterval(window["timer_secondsTimer" + t])),
      (t = null);
  }
  function c(t, e) {
    null != e.timeUp && 1 == n.isFunction(e.timeUp) && e.timeUp.apply(t, []),
      null != e.expiryUrl && (window.location = e.expiryUrl);
  }
  function S(n, t) {
    var e = t;
    if (
      "undefined" != typeof window["regexpMatchFormat_" + n.attr("id")] &&
      "undefined" != typeof window["regexpReplaceWith_" + n.attr("id")]
    ) {
